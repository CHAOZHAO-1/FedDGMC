...
def get_dataset(args,client):
    ...
    root_path='/home/dlzhaochao/deeplearning/DTL/data/' + args.dataset + 'data' + str(args.class_num) + '.mat'
    ...
    test_loader = torch.utils.data.DataLoader(data_t, batch_size=1400, shuffle=False, drop_last=False,
                                               num_workers=args.workers, pin_memory=args.pin)
